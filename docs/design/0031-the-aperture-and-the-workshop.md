...
| 3 | **The visible mind** — the `graph` panel kind; the work walk in the ledger; template narrative rendered beside its graph | a view over existing records; proven as a human in the glass (0030's standing rule) |
| 4 | **The metabolism** — freshness triggers + review_interval dial; reactivation rerank signal; the domain-package view on acquisition reports | rides 0022 Phase 2 |
