...
MANIFEST = {'key': 'options-desk',
 ...
 'port': 4522,
 'law': 'the desk observes and reports — never a trade, never an exercise',
 'door': 'options-desk',
 ...
 'view': [{'kind': 'controls',
           ...
           'buttons': [{'label': '🕰 watch it — stages at your gate',
                       ...
                       {'label': '📄 ask charles for a report now — your word '
                                 'is the approval',
          ...
          {'kind': 'flow',
           ...
           'nodes': ['retrieve-context', 'fetch-data', 'market-analyst',
                     'social-analyst', 'news-analyst', 'fundamentals-analyst',
                     'bull-researcher', 'bear-researcher', 'research-manager',
                     'trader', 'aggressive-risk', 'conservative-risk',
                     'neutral-risk', 'compare-to-prior', 'portfolio-manager',
                     'format-report'],
