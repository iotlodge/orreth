...
MANIFEST = {
 ...
 "view": [
  ...
  {"kind": "flow", "live": False, "story": True,
   "label": "how it works — you, the resident, the Farm, memory, and the law",
   "nodes": [
    {"id": "you", "kind": "human",
     "desc": "Ask, watch, schedule — your word approves."},
    {"id": "the-ask", "kind": "word",
     "desc": "A ticker on the queue, or a standing watch."},
    {"id": "resident", "kind": "resident",
     "desc": "The desk's own self, key proven at the gate."},
    {"id": "the-walk", "kind": "pipeline",
     "desc": "Sixteen stages, each one a signed record."},
    {"id": "data-stall", "kind": "farm",
     "desc": "Market data through the metered door."},
    {"id": "search", "kind": "farm",
     "desc": "The web under a declared daily ceiling."},
    {"id": "memory", "kind": "floor",
     "desc": "His floor keeps every stage and report."},
    {"id": "the-report", "kind": "report",
     "desc": "The morning read, the delta since last."},
    {"id": "the-law", "kind": "governance",
     "desc": "Gates, meters, and the two books."}],
   "edges": [
    {"from": "you", "to": "the-ask", "label": "1. ask"},
    {"from": "the-ask", "to": "resident", "label": "2. welcome"},
    {"from": "resident", "to": "the-walk", "label": "3. walk"},
    {"from": "the-walk", "to": "data-stall", "label": "4. fetch"},
    {"from": "the-walk", "to": "search", "label": "5. search"},
    {"from": "the-walk", "to": "memory", "label": "6. record"},
    {"from": "memory", "to": "the-report", "label": "7. deliver"},
    {"from": "the-law", "to": "the-walk", "label": "meters"}],
   "groups": [
    {"label": "your seat", "nodes": ["you", "the-ask"]},
    {"label": "the desk",
     "nodes": ["resident", "the-walk", "memory", "the-report"]},
    {"label": "the farm", "nodes": ["data-stall", "search"]}]},
  {"kind": "reports",
   "label": "past reports — every walk on the record"},
  {"kind": "chart", "detail": True, "preset": "market", "src": "charts"},
  {"kind": "tabs", "detail": True, "tabs": [
